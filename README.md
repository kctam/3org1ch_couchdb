...
Step 2: create a directory of channel-artifacts
```
mkdir channel-artifacts
```

Step 3: generate the required crypto material for organizations
```
../bin/cryptogen generate --config=./crypto-config.yaml
```

Step 4: generate the channel artifacts
```
mkdir channel-artifacts
...
Step 5: bring up all the containers, and you should see total 8 containers up and running
```
